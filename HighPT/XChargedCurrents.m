...
(* ::Subtitle:: *)
(*Charged current flavor observables - old implementation*)
...
(*Kto\[Pi]l\[Nu][proc_String,lep_] := (1+\[Delta]EM[proc]+\[Delta]SU2[proc])Sum[(Psi["VV"][proc]Abs[WCL["\[Nu]eduVLL",{nu,lep,2,1}] + WCL["\[Nu]eduVLR",{nu,lep,2,1}]]^2+Psi["VS"][proc]/(Mass["s"]-Mass["u"]) Re[(WCL["\[Nu]eduVLL",{nu,lep,2,1}] + WCL["\[Nu]eduVLR",{nu,lep,2,1}])(WCL["\[Nu]eduSRR",{nu,lep,3,1}]+WCL["\[Nu]eduSRL",{nu,lep,2,1}])\[Conjugate]]+Psi["VT"][proc]Re[(WCL["\[Nu]eduVLL",{nu,lep,2,1}] + WCL["\[Nu]eduVLR",{nu,lep,2,1}])WCL["\[Nu]eduTRR",{nu,lep,2,1}]\[Conjugate]]+Psi["SS"][proc]/(Mass["s"]-Mass["u"])^2 Abs[WCL["\[Nu]eduSRR",{nu,lep,2,1}] + WCL["\[Nu]eduSRL",{nu,lep,2,1}]]^2+Psi["TT"][proc]Abs[WCL["\[Nu]eduTRR",{nu,lep,2,1}]]^2),{nu,3}]*)
